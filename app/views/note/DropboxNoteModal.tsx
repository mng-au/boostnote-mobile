...
import * as CoffeeScript from '../../lib/CofeeScriptEval';
import * as NotePreview from './preview/NotePreviewComponent';
import * as NoteInputSupport from './inputSupport/NoteInputSupport';
import * as removeMd from 'remove-markdown-and-html';
import { default as HeaderComponent } from './HeaderComponent';
...
interface IDropboxNoteModelNote {
  content: string;
}

interface IDropboxNoteModalState {
  token: string;
  path: string;
  note: IDropboxNoteModelNote;
  height: number;
  isEditting: boolean;
...
export default class DropboxNoteModal extends React.Component<
  IDropboxNoteModalProps,
  IDropboxNoteModalState
> {
  constructor(props: IDropboxNoteModalProps, context?: any) {
    super(props, context);
  ...
  componentWillReceiveProps(props: IDropboxNoteModalProps) {
  ...
  getNoteComponent() {
    if (this.state.isEditting) {
      ...
      return (
        <NotePreview text={this.state.note.content} onTapCheckBox={this.tapCheckBox.bind(this)} />
      );
    }
  }
  ...
  insertMarkdownBetween(character) {
    ...
    const afterText = this.state.note.content.substring(
      this.state.endOfSelection,
        ...
        >
          <Container>
            ...
            <Content keyboardShouldPersistTaps="always">
              ...
              {this.state.isLoading ? null : this.getNoteComponent()}
            </Content>
          </Container>
        </Modal>
      </Root>
